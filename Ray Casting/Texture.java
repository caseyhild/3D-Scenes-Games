...
public class Texture
{
    ...
    public Texture(int size, String texName)
    {
        ...
        else if(texName.equals("default"))
        {
            try
            {
    ...
    public void update(String thisName, int frame)
    {
        ...
        if(thisName.equals("xor"))
            white = new Texture(64, "xor");
        if(thisName.equals("xorHSV"))
            white = new Texture(64, "xorHSV");
    }
    ...
    public void separate(Vector2D[] position, Vector2D[] velocity, int[] ballSize, int a, int b, double dist)
    {
